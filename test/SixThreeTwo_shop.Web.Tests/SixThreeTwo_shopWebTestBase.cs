...
public abstract class SixThreeTwo_shopWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static SixThreeTwo_shopWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(SixThreeTwo_shopWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<SixThreeTwo_shopDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<SixThreeTwo_shopDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<SixThreeTwo_shopDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<SixThreeTwo_shopDbContext, Task<T>> func)
    {
        T result;
