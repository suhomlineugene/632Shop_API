...
public abstract class 632ShopWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static 632ShopWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(632ShopWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<632ShopDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<632ShopDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<632ShopDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<632ShopDbContext, Task<T>> func)
    {
        T result;
