...
namespace SixThreeTwo_shop.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly SixThreeTwo_shopDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = SixThreeTwo_shopConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(SixThreeTwo_shopDbContext context)
    {
        _context = context;
    }
