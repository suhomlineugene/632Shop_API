...
namespace SixThreeTwo_shop.Migrations
{
    ...
    [Migration("20260920082418_AddedEditsToViscositiesTable")]
    partial class AddedEditsToViscositiesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SixThreeTwo_shop.Products.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SixThreeTwo_shop.Products.EngineOilViscosity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EngineOilViscosities");
                });
            ...
            modelBuilder.Entity("SixThreeTwo_shop.Products.TransmissionOilViscosity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TransmissionOilViscosities");
                });
            ...
            modelBuilder.Entity("SixThreeTwo_shop.Products.MotorOil", b =>
                {
                    ...
                    b.HasOne("SixThreeTwo_shop.Products.EngineOilViscosity", "OilViscosity")
                        .WithMany("EngineOils")
                        .HasForeignKey("ViscosityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OilViscosity");
            ...
            modelBuilder.Entity("SixThreeTwo_shop.Products.Product", b =>
                {
                    b.HasOne("SixThreeTwo_shop.Products.Brand", "Brand")
                        .WithMany("Products")
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SixThreeTwo_shop.Products.TransmissionFluid", b =>
                {
                    ...
                    b.HasOne("SixThreeTwo_shop.Products.TransmissionOilViscosity", "Viscosity")
                        .WithMany("TransmissionFluids")
                        .HasForeignKey("ViscosityId");
            ...
            modelBuilder.Entity("SixThreeTwo_shop.Products.TransmissionOilViscosity", b =>
                {
                    b.Navigation("TransmissionFluids");
                });
